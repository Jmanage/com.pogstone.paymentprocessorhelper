...
INNER JOIN civicrm_membership_payment mp ON m.id = mp.membership_id AND mp.contribution_id = %1
  ...
  public function pogstone_log_details() {
    ...
    $sql = "INSERT INTO pogstone_paypal_messages (
          rec_type,
          message_date,
          amount,
          txn_id,
      ...
      ";
    $sqlParams = array(
      '1' => array(CRM_Utils_Array::value('amount', $fields, ''), 'String'),
      '2' => array(CRM_Utils_Array::value('txn_id', $fields, ''), 'String'),
      '3' => array(CRM_Utils_Array::value('recurring_payment_id', $fields, ''), 'String'),
      '4' => array(CRM_Utils_Array::value('payment_date', $fields, ''), 'String'),
      '5' => array(CRM_Utils_Array::value('payment_status', $fields, ''), 'String'),
      '6' => array(CRM_Utils_Array::value('mc_gross', $fields, ''), 'String'),
      '7' => array(CRM_Utils_Array::value('mc_fee', $fields, ''), 'String'),
      '8' => array(CRM_Utils_Array::value('first_name', $fields, ''), 'String'),
      '9' => array(CRM_Utils_Array::value('last_name', $fields, ''), 'String'),
      '10' => array(CRM_Utils_Array::value('payer_email', $fields, ''), 'String'),
      '11' => array(CRM_Utils_Array::value('txn_type', $fields, ''), 'String'),
      '12' => array(CRM_Utils_Array::value('period_type', $fields, ''), 'String'),
      '13' => array(CRM_Utils_Array::value('payment_fee', $fields, ''), 'String'),
      '14' => array(CRM_Utils_Array::value('payment_gross', $fields, ''), 'String'),
      '15' => array(CRM_Utils_Array::value('currency_code', $fields, ''), 'String'),
      '16' => array(CRM_Utils_Array::value('mc_currency', $fields, ''), 'String'),
      '17' => array(CRM_Utils_Array::value('outstanding_balance', $fields, ''), 'String'),
      '18' => array(CRM_Utils_Array::value('next_payment_date', $fields, ''), 'String'),
      '19' => array(CRM_Utils_Array::value('protection_eligibility', $fields, ''), 'String'),
      '20' => array(CRM_Utils_Array::value('payment_cycle', $fields, ''), 'String'),
      '21' => array(CRM_Utils_Array::value('tax', $fields, ''), 'String'),
      '22' => array(CRM_Utils_Array::value('payer_id', $fields, ''), 'String'),
      '23' => array(CRM_Utils_Array::value('product_name', $fields, ''), 'String'),
      '24' => array(CRM_Utils_Array::value('charset', $fields, ''), 'String'),
      '25' => array(CRM_Utils_Array::value('rp_invoice_id', $fields, ''), 'String'),
      '26' => array(CRM_Utils_Array::value('notify_version', $fields, ''), 'String'),
      '27' => array(CRM_Utils_Array::value('amount_per_cycle', $fields, ''), 'String'),
      '28' => array(CRM_Utils_Array::value('payer_status', $fields, ''), 'String'),
      '29' => array(CRM_Utils_Array::value('business', $fields, ''), 'String'),
      '30' => array(CRM_Utils_Array::value('verify_sign', $fields, ''), 'String'),
      '31' => array(CRM_Utils_Array::value('initial_payment_amount', $fields, ''), 'String'),
      '32' => array(CRM_Utils_Array::value('profile_status', $fields, ''), 'String'),
      '33' => array(CRM_Utils_Array::value('payment_type', $fields, ''), 'String'),
      '34' => array(CRM_Utils_Array::value('receiver_email', $fields, ''), 'String'),
      '35' => array(CRM_Utils_Array::value('receiver_id', $fields, ''), 'String'),
      '36' => array(CRM_Utils_Array::value('residence_country', $fields, ''), 'String'),
      '37' => array(CRM_Utils_Array::value('receipt_id', $fields, ''), 'String'),
      '38' => array(CRM_Utils_Array::value('transaction_subject', $fields, ''), 'String'),
      '39' => array(CRM_Utils_Array::value('shipping', $fields, ''), 'String'),
      '40' => array(CRM_Utils_Array::value('product_type', $fields, ''), 'String'),
      '41' => array(CRM_Utils_Array::value('time_created', $fields, ''), 'String'),
      '42' => array(CRM_Utils_Array::value('ipn_track_id', $fields, ''), 'String'),
    );

    CRM_Core_Error::debug_log_message('paymentprocessorhelper: PayPalProIPN: ' . __FUNCTION__ . ': Log using SQL: ' . CRM_Core_DAO::composeQuery($sql, $sqlParams));
