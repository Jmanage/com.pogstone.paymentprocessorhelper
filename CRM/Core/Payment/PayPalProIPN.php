...
INNER JOIN civicrm_membership_payment mp ON m.id = mp.membership_id AND mp.contribution_id = %1
  ...
  public function pogstone_log_details() {
    ...
    $sql = "INSERT INTO pogstone_paypal_messages (
      ...
      ";
    $sqlParams = array(
      '1' => array($fields['amount'], 'String'),
      '2' => array($fields['txn_id'], 'String'),
      '3' => array($fields['recurring_payment_id'], 'String'),
      '4' => array($fields['payment_date'], 'String'),
      '5' => array($fields['payment_status'], 'String'),
      '6' => array($fields['mc_gross'], 'String'),
      '7' => array($fields['mc_fee'], 'String'),
      '8' => array($fields['first_name'], 'String'),
      '9' => array($fields['last_name'], 'String'),
      '10' => array($fields['payer_email'], 'String'),
      '11' => array($fields['txn_type'], 'String'),
      '12' => array($fields['period_type'], 'String'),
      '13' => array($fields['payment_fee'], 'String'),
      '14' => array($fields['payment_gross'], 'String'),
      '15' => array($fields['currency_code'], 'String'),
      '16' => array($fields['mc_currency'], 'String'),
      '17' => array($fields['outstanding_balance'], 'String'),
      '18' => array($fields['next_payment_date'], 'String'),
      '19' => array($fields['protection_eligibility'], 'String'),
      '20' => array($fields['payment_cycle'], 'String'),
      '21' => array($fields['tax'], 'String'),
      '22' => array($fields['payer_id'], 'String'),
      '23' => array($fields['product_name'], 'String'),
      '24' => array($fields['charset'], 'String'),
      '25' => array($fields['rp_invoice_id'], 'String'),
      '26' => array($fields['notify_version'], 'String'),
      '27' => array($fields['amount_per_cycle'], 'String'),
      '28' => array($fields['payer_status'], 'String'),
      '29' => array($fields['business'], 'String'),
      '30' => array($fields['verify_sign'], 'String'),
      '31' => array($fields['initial_payment_amount'], 'String'),
      '32' => array($fields['profile_status'], 'String'),
      '33' => array($fields['payment_type'], 'String'),
      '34' => array($fields['receiver_email'], 'String'),
      '35' => array($fields['receiver_id'], 'String'),
      '36' => array($fields['residence_country'], 'String'),
      '37' => array($fields['receipt_id'], 'String'),
      '38' => array($fields['transaction_subject'], 'String'),
      '39' => array($fields['shipping'], 'String'),
      '40' => array($fields['product_type'], 'String'),
      '41' => array($fields['time_created'], 'String'),
      '42' => array($fields['ipn_track_id'], 'String'),
    );
